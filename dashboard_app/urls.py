...
urlpatterns = [
    ...
    path('update_order_status/<int:order_id>/<int:booking_id>',views.update_order_status_new,name='update_order_status'),
    ...
    #On Counter Order Screen
    path('counter_orders_screen/',views.counter_orders_screen,name='counter_orders_screen'),
    path('counter_orders_screen_with_booking_id/<int:bookingid>/',views.counter_orders_screen_with_booking_id,name='counter_orders_screen_with_booking_id'),
    ...
    path('load_section_type_sub_categories/<str:section_type>/',views.load_section_type_sub_categories_other,name='load_section_type_sub_categories_other'),
    ...
    path('all_offers/update_offer_status/', views.update_offer_status, name='update_offer_status'),
